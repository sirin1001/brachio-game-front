...
public class LocalPlayerController : MonoBehaviour, IPlayerController
{
    ...
    void Start()
    {
        localPlayerController = this.GetComponent<IPlayerController>();
    ...
    {
        localPlayerController.OnMove(movementValue);
    }
    ...
    {
        localPlayerController.OnLook(LookValue);
    }
    ...
    {
        localPlayerController.OnTriggerStay2D(collision);
    }
    ...
    {
        localPlayerController.OnTriggerExit2D(other);
    }
